...
# إعدادات التوكن ومعرفك
TOKEN = "8690826652:AAEEjIT4WqXUKQgW6pKP6yPCD-ARZER9Abk"
CHAT_ID = "8690826652"

# 1. الصفحة الرئيسية (تظهر للزبون عند فتح الرابط ليجرب بنفسه)
@app.route('/')
def home():
...
# 2. مسار استقبال البيانات الحقيقية (Webhook)
...
def test_alert():
    send_telegram_alert("✅ تجربة ناجح: تم محاكاة طلب الزبون وإرسال التنبيه الفوري بنجاح!")
    return '''
